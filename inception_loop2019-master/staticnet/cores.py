...
# LaplaceL2 removed - using dummy function instead
...
class Stacked2dCore(Core2d, nn.Module):
    def __init__(self, input_channels, hidden_channels, input_kern, hidden_kern, layers=3,
        ...
        # LaplaceL2 removed - using dummy function that returns 0
        self._input_weights_regularizer = lambda x, weights=None: 0
